Ext.define('sacec.view.abstract.AbstractFilterWindow', {
	extend: 'Ext.window.Window',
	controller: 'sacec.controller.AbstractFilterWindowController',
	alias: 'widget.sacec-abstract-filter-window',
	modal: true,
