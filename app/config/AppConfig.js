...
Ext.define("sacec.config.AppConfig", {
  statics: {
  ...
  */
  ...
  constructor: function(cfg) {
    if ((cfg != null ? cfg.environment : void 0) && (sacec.config.AppConfig[cfg.environment] != null)) {
      return this.setEnvironment(sacec.config.AppConfig[cfg.environment]);
    } else {
      return this.setEnvironment(sacec.config.AppConfig.PRODUCTION_ENV);
    }
  },
  /**
